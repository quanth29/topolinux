...
public class DrawingCommandManager 
{
  ...
  int snapHotItemToNearestLine()
  {
    ...
    if ( TopoDroidApp.LOG_DEBUG ) { // ===== FIRST SET OF LOGS
      TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap to line");
      for ( LinePoint pt = lmin.mFirst; pt!=null; pt=pt.mNext ) TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, pt.mX + " " + pt.mY );
      TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap area");
      for ( LinePoint pt = area.mFirst; pt!=null; pt=pt.mNext ) TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, pt.mX + " " + pt.mY );
      TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap qq0= " + q0.mX + " " + q0.mY + " to pp0= " + pp0.mX + " " + pp0.mY );
    }
    ...
    // if ( kk1 >= 0 ) 
    if ( pp1 != null ) { 
      TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap pp1 " + pp1.mX + " " + pp1.mY + " FOLLOW LINE FORWARD" );
      // pp1  = pts1.get( kk1 );
      // pp10 = pts1.get( kk0 );
      pp10 = pp0;
      // if ( kk2 >= 0 ) 
      if ( pp2 != null ) {
        TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap pp2 " + pp2.mX + " " + pp2.mY );
        // pp2  = pts1.get( kk2 ); 
        // pp20 = pts1.get( kk0 ); 
        pp20 = pp0;
      }
      if ( pp1.distance( q1 ) < pp1.distance( q2 ) ) {
        ...
        qq10 = q0;
        TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap qq1 " + qq1.mX + " " + qq1.mY + " follow border forward" );
        // delta1 = 1;
        // if ( kk2 >= 0 ) 
        if ( pp2 != null ) {
          qq2  = q2;
          qq20 = q0;
          TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap qq2 " + qq2.mX + " " + qq2.mY );
          // delta2 = size0-1;
        }
      } else {
        // int k = k1; k1 = k2; k2 = k;
        ...
        qq10 = q0;
        TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap reverse qq1 " + qq1.mX + " " + qq1.mY + " follow border backward" );
        // delta1 = size0-1;
        // if ( kk2 >= 0 ) 
        if ( pp2 != null ) {
          qq2 = q1;
          qq20 = q0;
          TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap qq2 " + qq2.mX + " " + qq2.mY + " follow forward");
          // delta2 = 1;
        }
      }
    } else // if ( kk2 >= 0 ) 
      ...
      // pp20 = pts1.get( kk0 ); 
      pp20 = pp0;
      TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap pp1 null pp2 " + pp2.mX + " " + pp2.mY + " FOLLOW LINE BACKWARD" );
      if ( pp2.distance( q2 ) < pp2.distance( q1 ) ) {
        qq2 = q2;
        qq20 = q0;
        TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap qq2 " + qq2.mX + " " + qq2.mY + " follow border backward" );
        // delta2 = size0-1;
      } else {
        // int k = k1; k1 = k2; k2 = k;
        reverse = true;
        qq2 = q1;
        qq20 = q0;
        TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap reverse qq2 " + qq2.mX + " " + qq2.mY + " follow border forward" );
        // delta2 = 1;
      }
    ...
    if ( qq1 != null ) {
      TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "qq1 not null " + qq1.mX + " " + qq1.mY + " reverse " + reverse );
      // follow line pp10 --> pp1 --> ... using step 1
      // with border qq10 --> qq1 --> ... using step delta1

      for (int c=0; c<cmax; ++c) { // try to move qq1 forward
        TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap at qq1 " + qq1.mX + " " + qq1.mY );
        float s = project( qq1, pp10, pp1 );
        while ( s > 1.0 ) {
          // kk1 = ( kk1+1 < size1 )? kk1 + 1 : (min_is_area)? 0 : -1;
          // if ( kk1 < 0 || kk1 == kk0 ) break;
          pp10 = pp1;
          TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap follow pp10 " + pp10.mX + " " + pp10.mY );
          // pp1  = pts1.get( kk1 );
          pp1  = lmin.next( pp1 );
          if ( pp1 == null ) {
            TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap end of line pp1 null, pp10 " + pp10.mX + " " + pp10.mY );
            break;
          }
          if ( pp1 == pp0 ) {
            TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap pp1 == pp0, pp10 " + pp10.mX + " " + pp10.mY );
            break;
          }
        ...
        TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "distance d1 " + d1 + " s " + s );
      ...
      TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap qq1 null" );
      qq10 = q0; // FIXME
    }
    if ( qq10 != null && pp10 != null ) {
      TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "QQ10 " + qq10.mX + " " + qq10.mY + " PP10 " + pp10.mX + " " + pp10.mY );
    }

    if ( qq2 != null ) {
      TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "qq2 not null: " + qq2.mX + " " + qq2.mY + " reverse " + reverse );
      ...
      for (int c=0; c < cmax; ++c) { // try to move qq2 backward
        TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap at qq2 " + qq2.mX + " " + qq2.mY );
        float s = project( qq2, pp20, pp2 );
        while ( s > 1.0 ) {
          // kk2 = ( kk2 > 0 )? kk2 - 1 : (min_is_area)? size1-1 : -1;
          // if ( kk2 < 0 || kk2 == kk0 ) break;
          pp20 = pp2;
          TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap s>1, follow pp20 " + pp20.mX + " " + pp20.mY );
          // pp2 = pts1.get( kk2 );
          pp2 = lmin.prev( pp2 );
          if ( pp2 == null ) {
            TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap end of line pp2 null, pp20 " + pp20.mX + " " + pp20.mY );
            break;
          }
          if ( pp2 == pp0 ) {
            TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap pp2 == pp0, pp20 " + pp20.mX + " " + pp20.mY );
            break;
          }
        ...
        TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "distance qq2-P_line " + d2 + " s " + s );
      ...
      TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap qq2 null");
      qq20 = q0; // FIXME
    }
    if ( qq20 != null && pp20 != null ) {
      TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "QQ20 " + qq20.mX + " " + qq20.mY + " PP20 " + pp20.mX + " " + pp20.mY );
    }
    ...
    synchronized( mCurrentStack ) {
      if ( ret == 0 ) { 
        ...
        if ( prev == null ) {
          ...
          TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap setting area FIRST null ");
        } else {
          TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap start prev " + prev.mX + " " + prev.mY );
          LinePoint q = prev;
          ...
          TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap setting area FIRST " + area.mFirst.mX + " " + area.mFirst.mY );
        }

        if ( next == null ) {
          area.mLast = null; // ( reverse )? qq20 : qq10;
          TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap setting area LAST null ");
        } else {
          TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap start next " + next.mX + " " + next.mY );
          LinePoint q = next;
          ...
          TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap setting area LAST " + area.mLast.mX + " " + area.mLast.mY );
        }
        ...
        if ( reverse ) {
          ...
          LinePoint p = pp10;
          if ( q != null ) {
            TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap attach at " + q.mX + " " + q.mY );
          } else {
            TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap restart area ");
          }
          q = new LinePoint( p.mX, p.mY, q );
          TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap first new point " + q.mX + " " + q.mY );
          if ( p != pp20 ) {
            p = p.mPrev;
            ...
            for ( ; p != null && p != pp20; p = p.mPrev ) {
              ...
              TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap new point " + q.mX + " " + q.mY );
            }
            if ( p != null ) { // FIXME add last point
              ...
              TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap last new point " + q.mX + " " + q.mY );
            }
          }
          q.mNext = next;
          if ( next != null ) {
        ...
        area.recount(); 
        TopoDroidApp.Log( TopoDroidApp.LOG_DEBUG, "snap new size " + area.size() );
      }
