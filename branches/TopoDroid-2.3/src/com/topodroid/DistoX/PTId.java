...
class PTId
{
  ...
  void set( String str )
  {
    TopoDroidApp.Log( TopoDroidApp.LOG_PTOPO, "PT ID set " + str ); 
    ...
    if ( vals.length > 1 ) {
      ...
      try {
        ...
        TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "PTId::set major/minor parse error " + vals[0] + " " + vals[1] );
      }
      ...
      try { 
        ...
        TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "PTId::set setNumber parse error " + str );
  ...
  void setNumber( int n ) { _id = n - 0x80000001; }
  ...
  public String toString()
  {
    ...
    pw.printf( "%d.%d", _id>>16, _id & 0xffff );
