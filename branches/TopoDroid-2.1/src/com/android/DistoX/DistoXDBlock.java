...
public class DistoXDBlock
{
  ...
  public static final int BLOCK_BLANK_LEG  = 4; // blank centerlien leg-shot
  ...
  public String toString( boolean show_id )
  {
    ...
    TopoDroidApp.Log( TopoDroidApp.LOG_DATA, "DBlock::toString From " + mFrom + " To " + mTo + " data " + mLength + " " + mBearing + " " + mClino );
    StringWriter sw = new StringWriter();
    PrintWriter pw  = new PrintWriter(sw);
    if ( show_id ) pw.format("%d ", mId );
    pw.format("<%s-%s> %.2f %.1f %.1f [%c]",
      mFrom, mTo,
  ...
  public String dataString()
  {
    ...
    StringWriter sw = new StringWriter();
    PrintWriter pw  = new PrintWriter(sw);
    pw.format("L %.2f  N %.1f  I %.1f", mLength*ul, mBearing*ua, mClino*ua );
    return sw.getBuffer().toString();
  }
  ...
  public String extraString()
  {
    ...
    StringWriter sw = new StringWriter();
    PrintWriter pw  = new PrintWriter(sw);
    pw.format("A %.2f  M %.1f  D %.1f", mAcceleration, mMagnetic, mDip*ua );
    return sw.getBuffer().toString();
  }
