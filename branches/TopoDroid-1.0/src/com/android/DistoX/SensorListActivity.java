...
*/
  ...
  {
    // TopoDroidApp.Log( TopoDroidApp.LOG_SENSOR, "updateDisplay() status: " + StatusName() + " forcing: " + force_update );
  ...
  {
    // TopoDroidApp.Log(TopoDroidApp.LOG_SENSOR, "updateSensorList size " + list.size() );
    mDataAdapter.clear();
...
*/
  ...
  {
    // TopoDroidApp.Log( TopoDroidApp.LOG_SENSOR, "updateSensor comment " + comment );
