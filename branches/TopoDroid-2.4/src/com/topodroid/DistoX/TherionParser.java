            ...
            if ( cmd.equals("encoding" ) ) { 
              ...
              for ( int j=2; j<vals_len; ++j ) {
                if ( vals[j].equals("-declination") && j+1 < vals_len ) {
                  try {
                    ...
                    TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "therion parser error: -declination " + line );
                  }
              ...
              // } else if ( cmd.equals("instrument") ) {
                ...
                try {
                  ...
                  TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "therion parser error: scale/zero " + line );
                  zero  = scale;
                }
                if ( clen ) {
                  state.mZeroLen = zero;
                ...
                try {
                  ...
                  TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "therion parser error: units " + line );
                }
                if ( ulen ) {
	            ...
	            fixes.add( new Fix( name,
                    ...
                    TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "therion parser error: fix " + line );
                  }
                }
                ...
                try {
                  ...
                  TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "therion parser error: data " + line );
                }
              }            
