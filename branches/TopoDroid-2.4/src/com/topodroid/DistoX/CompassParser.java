...
public class CompassParser
{
  ...
  private void readFile( String filename ) throws ParserException
  {
        ...
        if ( line.startsWith("SURVEY NAME") ) {
          ...
          if ( kmax >= 5 && ! vals[0].equals("FROM") ) {
            ...
            try {
              ...
              TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "ERROR " + mLineCnt + ": " + line );
              TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "ERROR " + e );
            }
          }
        }
        line = nextLine( br );
    ...
    TopoDroidApp.Log( TopoDroidApp.LOG_THERION, "CompassParser shots "+ shots.size() +" splays "+ splays.size()  );
