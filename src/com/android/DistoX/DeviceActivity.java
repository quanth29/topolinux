...
// -------------------------------------------------------------------
  ...
  // int index2addrX310( int idx )
  // {
  //   int addr = 0;
  //   while ( idx >= 56 ) {
  //     idx -= 56;
  //     addr += 1024; // 1 KB block
  //   }
  //   return addr + 18 * idx;
  // }
  ...
  {
    Toast.makeText(this, "WARNING X310 memory reset not implememnted yet", Toast.LENGTH_SHORT ).show();
  }
