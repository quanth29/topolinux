...
public class DistoXProtocol
{
  ...
  //     mBuffer[1] = (byte)( addr & 0xff );
  //     mBuffer[2] = (byte)( (addr>>8) & 0xff );
  //     TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "resetMemory() address " + mBuffer[1] + " " + mBuffer[2] );
  ...
  //       mIn.readFully( mBuffer, 0, 8 );
  //     } catch ( IOException e ) {
  //       TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "resetMemory() IO nr. 1 failed" );
  //       break;
  //     }
  //     if ( mBuffer[0] != (byte)( 0x38 ) ||
  //          mBuffer[1] != (byte)( addr & 0xff ) ||
  ...
  //       mIn.readFully( mBuffer, 0, 8 );
  //     } catch ( IOException e ) {
  //       TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "resetMemory() IO nr. 2 failed" );
  //       break;
  //     }
  //     if ( mBuffer[0] != (byte)( 0x38 ) ||
  //          mBuffer[1] != (byte)( addr & 0xff ) ||
    ...
    try {
      ...
      for ( int addr = 0; /* addr < end_addr */; ++ addr ) {
        ...
        try {
          ...
          TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "EOF " + e.getMessage() );
          break;
        } catch ( IOException e ) { 
          TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "IO error " + e.getMessage() );
          ok = false;
          break;
        }
      }
