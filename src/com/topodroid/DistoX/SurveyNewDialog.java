...
// -------------------------------------------------------------------
  ...
  protected void onCreate( Bundle savedInstanceState) 
  {
    ...
    if ( TopoDroidApp.mDefaultTeam.length() > 0 ) {
      mEditTeam.setText( TopoDroidApp.mDefaultTeam );
    }
  ...
  public void onClick(View view)
  {
    ...
    // TopoDroidApp.Log( TopoDroidApp.LOG_INPUT, "SurveyDialog onClick() " + item.toString() );
    if ( b == mBTsave ) {
    ...
    if ( mEditDecl.getText() != null ) {
      ...
      if ( decl_str != null && decl_str.length() > 0 ) {
        ...
        try {
          ...
          TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "parse Double error: declination " + decl_str );
        }
      }
    }
