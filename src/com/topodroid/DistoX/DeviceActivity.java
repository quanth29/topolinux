...
// -------------------------------------------------------------------
  ...
  protected void onCreate(Bundle savedInstanceState) 
  {
    ...
    mNrButton1 = TopoDroidApp.mLevelOverNormal ? 6 : 2;
  ...
  public void onItemClick(AdapterView<?> parent, View view, int pos, long id)
  {
    if ( mMenu == (ListView)parent ) {
      ...
      } else if ( TopoDroidApp.mLevelOverBasic && p++ == pos ) { // DETACH
        detachDevice();
      ...
      } else if ( mApp.mBootloader && p++ == pos ) { // FIRMWARE
  ...
  */
  ...
  private void setMenuAdapter()
  {
    ...
    if ( mApp.mBootloader ) mMenuAdapter.add( res.getString( menus[3] ) );
