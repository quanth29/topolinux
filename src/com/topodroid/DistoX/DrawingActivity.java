                                      ...
                                      , ILister
{
  ...
  void setButton3( int type )
  {
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
      ...
      int nr_button1 = 8;          // main-primary
      int nr_button2 = 6;          // draw
      int nr_button3 = 7;          // edit
      // int nr_button4 = 5;          // main-secondary
      int nr_button5 = 3;          // erase
      ...
      // mButton1[k1++].setBackgroundResource(  R.drawable.ic_more ); // more --> details
      mButton1[k1++].setBackgroundResource(  R.drawable.ic_info ); // ic_details );

      // int k4 = 0;
      // mButton4[k4++].setBackgroundResource(  R.drawable.ic_less );
      // mButton4[k4++].setBackgroundResource(  R.drawable.ic_download );
      // mButton4[k4++].setBackgroundResource(  R.drawable.ic_info ); // ic_details );
      ...
      if ( mApp.mDevice == null ) {
        ...
        mButton1[DOWNLOAD_BUTTON].setBackgroundResource(  R.drawable.ic_add );
      }
      ...
      // if ( width > (nr_button1 + nr_button4 - 2 )*50 ) {
      //   Button[] button14 = new Button[ nr_button1 + nr_button4 - 2];
      //   int k=0;
      //   for ( ; k < nr_button1-1; ++k ) button14[k] = mButton1[k];
      //   for ( ; k < nr_button1+nr_button4-2; ++k ) button14[k] = mButton4[k+2-nr_button1];
      //   mButtonView1 = new HorizontalButtonView( button14 );
      //   mButtonView4 = null;
      // } else {
   ...
   private void resetReference( PlotInfo plot )
   {
    ...
    private void makePopup( View b )
    {
        ...
        int h = (int)( (Math.abs(fm.top) + Math.abs(fm.bottom) + Math.abs(fm.leading) ) * 7 * 1.25);
  ...
  public boolean onCreateOptionsMenu(Menu menu) 
  {
    ...
    // mMIrefs    = menu.add( R.string.menu_display );
    ...
    mMIrecover   = menu.add( R.string.menu_recover );
    mMIhelp    = menu.add( R.string.menu_help  );

    // mMIrefs.setIcon( R.drawable.ic_refs );
    mMIsymbol.setIcon( R.drawable.ic_symbol );
    mMIsave.setIcon( R.drawable.ic_export );
    mMIdelete.setIcon( R.drawable.ic_trash );
    mMIoptions.setIcon( R.drawable.ic_pref );
    mMIrecover.setIcon( R.drawable.ic_logs );
