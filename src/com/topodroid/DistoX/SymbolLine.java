  	  ...
  	  if ( vals[k].equals("symbol") ) {
  	    ...
  	    if ( k < s ) {
  	      ...
  	      if ( k < s ) {
              ...
              TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "parse width error: " + line );
            }
  	    ...
  	    if ( k < s ) {
              ...
              if ( ndash > 0 ) {
  	          ...
  	          x[0] = Float.parseFloat( vals[k] );
                 ...
                 TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "parse dash error: " + line );
                }
              }
            }
              ...
              if ( k < s ) {
                if ( vals[k].equals("moveTo") ) {
                  try {
                    ...
                    TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "parse moveTo point error: " + line );
                  }
  	            ...
  	            if ( k < s ) {
                    ...
                    TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "parse lineTo point error: " + line );
                  }
