                       ...
                       implements SensorEventListener
{
  ...
  Context mContext; 
  ShotNewDialog mParent;
  boolean mRun;

  TimerTask( Context context, ShotNewDialog parent )
  {
    mContext = context;
    mParent  = parent;
    mRun = true;
  ...
  {
    int count = TopoDroidApp.mTimerCount;
    int duration = 100; // ms
    ToneGenerator toneG = new ToneGenerator( AudioManager.STREAM_ALARM, TopoDroidApp.mBeepVolume );
    long ret = 0;
