        ...
        for (int k=0; k<s; ++k ) {
          ...
          if ( vals[k].equals("symbol") ) {
            ...
            try {
              ...
              TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "parse csurvey error: " + line );
            }
    ...
    for ( int k = 0; k<s; ++k ) {
      ...
      if ( "moveTo".equals( vals[k] ) ) {
        try {
          ...
          TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "parse moveTo error: " + path );
        }
        ...
        try {
          ...
          TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "parse lineTo error: " + path );
        }
        ...
        try {
          ...
          TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "parse cubicTo error: " + path );
        }
        ...
        try {
          ...
          TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "parse circle error: " + path );
        }
        ...
        try {
          ...
          TopoDroidApp.Log( TopoDroidApp.LOG_ERR, "parse arcTo error: " + path );
        }
      }
    }
