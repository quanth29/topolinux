...
public class DataHelper extends DataSetObservable
{
  ...
  public SurveyStat getSurveyStat( long sid )
  {
   ...
   public void updateShotAMDR( long sid, long id, double acc, double mag, double dip, double r )
   {
     if ( myDB == null ) return;
   ...
   public long insertShotAt( long sid, long at, 
...
*/
   ...
   public CalibInfo selectCalibInfo( long cid )
   {
     ...
     if (cursor.moveToFirst()) {
       ...
       info.algo    = (int)cursor.getLong( 4 );
     }
     if (cursor != null && !cursor.isClosed()) {
       cursor.close();
     }
   ...
   */
  void dropDeletedFixed( long sid, String station )
  {
       ...
       if ( table.equals(SURVEY_TABLE) ) {
         ...
         while ( (line = br.readLine()) != null ) {
           ...
           if ( table.equals(PHOTO_TABLE) ) {
             ...
             insertPlot( sid, id, name, type, status, start, view, xoffset, yoffset, zoom, azimuth );
           ...
           //   insertSketch3d( sid, id, name, status, start, st1, st2, xofft, yofft, zoomt, xoffs, yoffs, zooms, xoff3, yoff3, zoom3, east, south, vert, azimuth, clino );
             ...
             updateShotAMDR( sid, id, acc, mag, dip, r );
