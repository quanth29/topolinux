...
public class DrawingBrushPaths
{
  ...
  public static Paint highlightPaint3 = null;
  public static Paint fixedShotPaint  = null;
  public static Paint fixedBluePaint  = null;
  public static Paint fixedSplayPaint = null;
  public static Paint fixedSplay2Paint = null;  // cross-section splay2 (at viewed station)
  ...
  public static void doMakePaths()
  {
    ...
    highlightPaint3.setStrokeWidth( STROKE_WIDTH_CURRENT );
    ...
    fixedShotPaint.setStrokeWidth( STROKE_WIDTH_FIXED * TopoDroidSetting.mLineThickness );
    ...
    fixedBluePaint.setStrokeWidth( STROKE_WIDTH_FIXED * TopoDroidSetting.mLineThickness );
    ...
    fixedSplayPaint.setStrokeWidth( STROKE_WIDTH_FIXED * TopoDroidSetting.mLineThickness );
    ...
    fixedSplay2Paint.setStrokeWidth( STROKE_WIDTH_FIXED * TopoDroidSetting.mLineThickness );
    ...
    fixedGridPaint.setStrokeWidth( STROKE_WIDTH_FIXED ); //* TopoDroidSetting.mLineThickness );
    ...
    fixedGrid10Paint.setStrokeWidth( STROKE_WIDTH_FIXED ); // * TopoDroidSetting.mLineThickness );
