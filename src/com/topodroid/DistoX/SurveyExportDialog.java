...
// -------------------------------------------------------------------
  ...
  protected void onCreate(Bundle savedInstanceState) 
  {
    ...
    if ( TopoDroidApp.mLevelOverAdvanced ) {
      ...
      mBtnSrv.setVisibility( View.GONE );
    }
  ...
  public void onClick(View v) 
  {
    ...
    if ( b == mBtnTh ) {
      ...
      mParent.doExport( TopoDroidApp.DISTOX_EXPORT_TOP, true );
    } else if ( b == mBtnCsx ) {
      mParent.doExport( TopoDroidApp.DISTOX_EXPORT_CSX, true );
    } else if ( b == mBtnDxf ) {
      mParent.doExport( TopoDroidApp.DISTOX_EXPORT_DXF, true );
    } else if ( b == mBtnCsv ) {
      mParent.doExport( TopoDroidApp.DISTOX_EXPORT_CSV, true );
    } else if ( b == mBtnSrv ) {
      mParent.doExport( TopoDroidApp.DISTOX_EXPORT_SRV, true );
    } else if ( b == mBtnZip ) {
      mParent.doArchive( );
